				...
				<div class="col-md-4 w3ls_dresses_grid_left">
					...
					<div class="w3ls_dresses_grid_left_grid">
						<div class="dresses_img_hover">
							<img src="{{url('public')}}/assets/images/47.jpg" alt=" " class="img-responsive" />
				...
				<div class="col-md-8 w3ls_dresses_grid_right">
					<div class="col-md-6 w3ls_dresses_grid_right_left">
						<div class="w3ls_dresses_grid_right_grid1">
							<img src="{{url('public')}}/assets/images/48.jpg" alt=" " class="img-responsive" />
					...
					<div class="col-md-6 w3ls_dresses_grid_right_left">
						<div class="w3ls_dresses_grid_right_grid1">
							<img src="{{url('public')}}/assets/images/49.jpg" alt=" " class="img-responsive" />
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div class="agile_ecommerce_tab_left dresses_grid">
								<div class="hs-wrapper hs-wrapper2">
									...
									<img src="{{url('public')}}/assets/images/51.jpg" alt=" " class="img-responsive" />
									<img src="{{url('public')}}/assets/images/29.jpg" alt=" " class="img-responsive" />
									<img src="{{url('public')}}/assets/images/38.jpg" alt=" " class="img-responsive" />
									<img src="{{url('public')}}/assets/images/37.jpg" alt=" " class="img-responsive" />
									<img src="{{url('public')}}/assets/images/30.jpg" alt=" " class="img-responsive" />
			...
			<ul id="flexiselDemo2">			
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left dresses_grid">
							<div class="hs-wrapper hs-wrapper3">
								<img src="{{url('public')}}/assets/images/55.jpg" alt=" " class="img-responsive" />
								<img src="{{url('public')}}/assets/images/34.jpg" alt=" " class="img-responsive" />
								<img src="{{url('public')}}/assets/images/30.jpg" alt=" " class="img-responsive" />
								<img src="{{url('public')}}/assets/images/36.jpg" alt=" " class="img-responsive" />
								<img src="{{url('public')}}/assets/images/37.jpg" alt=" " class="img-responsive" />
