		...
		<div class="container">	
			<div class="w3ls_about_grids">
				...
				<div class="col-md-6 w3ls_about_grid_right">
					<img src="{{url('public')}}/assets/images/77.jpg" alt=" " class="img-responsive" />
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="wthree_team_grids">
				<div class="col-md-3 wthree_team_grid">
					<img src="{{url('public')}}/assets/images/8.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="{{url('public')}}/assets/images/9.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="{{url('public')}}/assets/images/10.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="{{url('public')}}/assets/images/11.png" alt=" " class="img-responsive" />
