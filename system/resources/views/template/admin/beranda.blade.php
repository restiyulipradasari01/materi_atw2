...
@section('content')
						...
						<!--//area-->
							...
							<div class="col-md-7 mid-content-top">
								<div class="middle-content">
									...
									<!-- start content_slider -->
										<div id="owl-demo" class="owl-carousel text-center">
											<div class="item">
												<img class="lazyOwl img-responsive" data-src="{{url('public')}}/assets_admin/images/na.jpg" alt="name">
											</div>
											<div class="item">
												<img class="lazyOwl img-responsive" data-src="{{url('public')}}/assets_admin/images/na1.jpg" alt="name">
											</div>
											<div class="item">
												<img class="lazyOwl img-responsive" data-src="{{url('public')}}/assets_admin/images/na2.jpg" alt="name">
											</div>
											<div class="item">
												<img class="lazyOwl img-responsive" data-src="{{url('public')}}/assets_admin/images/na.jpg" alt="name">
											</div>
								...
								<link href="{{url('public')}}/assets_admin/css/owl.carousel.css" rel="stylesheet">
								<script src="{{url('public')}}/assets_admin/js/owl.carousel.js"></script>
									<script>
			...
			<div class="col-md-6 content-top-2">
				...
				<!--graph-->
					<link rel="stylesheet" href="{{url('public')}}/assets_admin/css/graph.css">
				<!--//graph-->
							<script src="{{url('public')}}/assets_admin/js/jquery.flot.js"></script>
									<script>
									$(document).ready(function () {
							...
							<div style="area">
								...
								<button id="randomizeData">Randomize Data</button>
										<script>
											...
											<script src="{{url('public')}}/assets_admin/js/Chart.js"></script>
					</div>
